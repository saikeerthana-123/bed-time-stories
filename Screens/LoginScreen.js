...
export default class LoginScreen extends React.Component{
  ...
  render(){
    return(
     ...
     <View>
     <TouchableOpacity style={{height:30,width:85,borderWidth:2,alignSelf:'center',backgroundColor:"#C7CEEA"}}
     onPress={()=>{
